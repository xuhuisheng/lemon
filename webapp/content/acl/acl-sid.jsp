...
var config = {
	...
	gridFormId: 'aclSidGridForm',
	exportUrl: 'acl-sid!exportExcel.do'
};
  ...
  <body>
    ...
    <section id="m-main" class="span10">
	  ...
	  <article class="m-blank">
	    <div class="pull-left">
		  <button class="btn btn-small" onclick="location.href='acl-sid!input.do'">新建</button>
...
<form id="aclSidGridForm" name="userGridForm" method='post' action="acl-sid!removeAll.do" class="m-form-blank">
  <table id="userGrid" class="m-table table-hover">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td>
          <a href="acl-sid!input.do?id=${item.id}"><spring:message code="core.list.edit" text="编辑"/></a>
        </td>
      </tr>
      </s:iterator>
    </tbody>
