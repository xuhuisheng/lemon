...
<form id="userForm" method="post" action="acl-sid!save.do?operationMode=STORE" class="form-horizontal">
  ...
  <div class="control-group">
	...
	<div class="controls">
	  <input id="user_username" type="text" name="name" value="${model.name}" size="40" class="text required" minlength="1" maxlength="10">
    </div>
  </div>
  <div class="control-group">
    <label class="control-label" for="user_username">类型</label>
	<div class="controls">
	  <select name="typeId">
      <s:iterator value="aclSidTypes" var="item">
