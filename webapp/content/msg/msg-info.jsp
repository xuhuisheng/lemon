...
var config = {
	...
	exportUrl: 'msg-info!exportExcel.do'
};
    ...
    <div class="row-fluid">
	  ...
	  <article class="m-widget">
        ...
        <div id="msg-infoSearch" class="content content-inner">
		  ...
		  <form name="msg-infoForm" method="post" action="msg-info.do" class="form-inline">
      ...
      <article class="m-widget">
        ...
        <div class="content">
<form id="msg-infoGridForm" name="msg-infoGridForm" method='post' action="msg-info!removeAll.do" class="m-form-blank">
