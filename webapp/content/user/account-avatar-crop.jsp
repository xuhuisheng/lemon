...
<html>
  ...
  <head>
    ...
    <link rel="stylesheet" href="${scopePrefix}/s/jcrop/css/jquery.Jcrop.min.css" type="text/css" media="screen" />
    <script type="text/javascript" src="${scopePrefix}/s/jcrop/js/jquery.Jcrop.min.js"></script>
