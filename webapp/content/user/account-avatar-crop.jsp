...
<html>
  ...
  <head>
    ...
    <link rel="stylesheet" href="${tenantPrefix}/jcrop/css/jquery.Jcrop.min.css" type="text/css" media="screen" />
    <script type="text/javascript" src="${tenantPrefix}/jcrop/js/jquery.Jcrop.min.js"></script>
