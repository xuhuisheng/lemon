...
<html>
  ...
  <head>
	...
	<link rel="stylesheet" href="${ctx}/cdn/jquery-file-upload/css/jquery.fileupload.css">
	<script src="${ctx}/cdn/jquery-file-upload/js/vendor/jquery.ui.widget.js"></script>
	<script src="${ctx}/cdn/jquery-file-upload/js/jquery.iframe-transport.js"></script>
	<script src="${ctx}/cdn/jquery-file-upload/js/jquery.fileupload.js"></script>
