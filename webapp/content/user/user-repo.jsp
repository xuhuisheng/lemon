...
var config = {
	...
	exportUrl: 'user-repo!exportExcel.do'
};
...
$(function() {
    ...
    <section id="m-main" class="span10">
	  ...
	  <article class="m-widget">
        ...
        <div id="userRepoSearch" class="content content-inner">
		  ...
		  <form name="userRepoForm" method="post" action="user-repo.do" class="form-inline">
  ...
  <form id="userRepoGridForm" name="userRepoGridForm" method='post' action="user-repo!removeAll.do" style="margin:0px;">
