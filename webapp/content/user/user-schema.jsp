...
var config = {
	...
	exportUrl: 'user-schema!exportExcel.do'
};
...
$(function() {
    ...
    <section id="m-main" class="span10">
	  ...
	  <article class="m-widget">
        ...
        <div id="userSchemaSearch" class="content content-inner">
		  ...
		  <form name="userSchemaForm" method="post" action="user-schema.do" class="form-inline">
  ...
  <form id="userSchemaGridForm" name="userSchemaGridForm" method='post' action="user-schema!removeAll.do?userRepoId=${param.userRepoId}" style="margin:0px;">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            ...
            <a href="user-schema!input.do?id=${item.id}&userRepoId=${userRepoId}" class="a-update"><spring:message code="core.list.edit" text="编辑"/></a>&nbsp;
			</region:region-permission>
          </td>
        </tr>
        </s:iterator>
