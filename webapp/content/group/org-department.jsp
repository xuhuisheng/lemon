...
var config = {
	...
	exportUrl: 'org-department!exportExcel.do'
};
    ...
    <section id="m-main" class="span10">
	  ...
	  <article class="m-widget">
        ...
        <div id="orgSearch" class="content content-inner">
		  ...
		  <form name="orgForm" method="post" action="org-department.do" class="form-inline">
	  ...
	  <article class="m-blank">
	    <div class="pull-left">
		  ...
		  <button class="btn btn-small" onclick="location.href='org-department!input.do'">新建</button>
...
<form id="orgGridForm" name="orgGridForm" method='post' action="org-department!removeAll.do" class="m-form-blank">
  <table id="orgGrid" class="m-table table-hover">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td>${item.name}</td>
        <td>
          <a href="org-department!input.do?id=${item.id}"><spring:message code="core.list.edit" text="编辑"/></a>
        </td>
      </tr>
      </s:iterator>
    </tbody>
