...
<html lang="en">
  ...
  <head>
    ...
    <title><spring:message code="org.org.list.title" text="用户列表"/></title>
...
-->
		  <button class="btn" onclick="location.href='group-base!pagedQueryUser.do?groupBaseId=${groupBaseId}'">管理下属</button>
		  <button class="btn" onclick="location.href='group-base!pagedQueryChildren.do?groupBaseId=${groupBaseId}'">下级组织</button>
		  <button class="btn" onclick="location.href='group-base!inputGroup.do?groupBaseId=${groupBaseId}'">组织信息</button>
		  <br>
		  <br>
	  ...
	  <article class="m-blank">
	    <div class="pull-left">
		  ...
		  <button class="btn btn-small" onclick="location.href='group-base!inputChild.do?groupBaseId=${groupBaseId}'">新建</button>
      ...
      <article class="m-widget">
        <header class="header">
		  <h4 class="title">下级组织列表</h4>
		</header>
		<div class="content">

<form id="orgGridForm" name="orgGridForm" method='post' action="group-base!removeChild.do?groupBaseId=${groupBaseId}" class="m-form-blank">
  <table id="orgGrid" class="m-table table-hover">
    <thead>
      <tr>
        ...
        <th class="sorting" name="groupType.id">类型</th>
        <th width="80">&nbsp;</th>
      </tr>
    </thead>
    ...
    <tbody>
      ...
      <tr>
        ...
        <td>
          <a href="group-base!inputChild.do?id=${item.id}&groupBaseId=${groupBaseId}"><spring:message code="core.list.edit" text="编辑"/></a>
        </td>
      </tr>
      </s:iterator>
    </tbody>
