...
<%pageContext.setAttribute("currentMenu", "group-sys");%>
<!doctype html>
<html lang="en">
...
var config = {
	...
	exportUrl: 'group-type!exportExcel.do'
};
    ...
    <section id="m-main" class="span10">
	  ...
	  <article class="m-widget">
        ...
        <div id="orgSearch" class="content content-inner">
		  ...
		  <form name="orgForm" method="post" action="group-type.do" class="form-inline">
	  ...
	  <article class="m-blank">
	    <div class="pull-left">
		  ...
		  <button class="btn btn-small" onclick="location.href='group-type!input.do'">新建</button>
      ...
      <article class="m-widget">
        <header class="header">
		  <h4 class="title"><spring:message code="org.org.list.title" text="用户列表"/></h4>
		</header>
		<div class="content">

<form id="orgGridForm" name="orgGridForm" method='post' action="group-type!removeAll.do" class="m-form-blank">
  <table id="orgGrid" class="m-table table-hover">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td>${item.name}</td>
        <td>
          <a href="group-type!input.do?id=${item.id}"><spring:message code="core.list.edit" text="编辑"/></a>
        </td>
      </tr>
      </s:iterator>
    </tbody>
	  ...
	  <article>
		...
		<div class="btn-group-type m-pagination pull-right">
