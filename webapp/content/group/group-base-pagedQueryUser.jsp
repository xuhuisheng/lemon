...
-->
	  ...
	  <article class="m-blank">
	    <div class="pull-left">
		  ...
		  <button class="btn btn-small" onclick="location.href='group-base!inputUser.do?groupBaseId=${groupBaseId}'">新建</button>
...
<form id="orgGridForm" name="orgGridForm" method='post' action="group-base!removeUser.do?groupBaseId=${groupBaseId}" class="m-form-blank">
