  ...
  <body>
    ...
    <div class="row-fluid">
	  ...
	  <article class="m-blank">
	    <div class="pull-left">
		  <region:region-permission permission="group-info:create">
		  <button class="btn btn-small a-insert" onclick="location.href='group-info-input.do'">新建</button>
      ...
      <article class="m-widget">
        ...
        <div class="content">
<form id="groupInfoGridForm" name="scope-infoGridForm" method='post' action="group-info-remove.do" class="m-form-blank">
