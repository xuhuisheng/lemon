...
var config = {
	...
	exportUrl: 'meeting-room!exportExcel.do'
};
    ...
    <div class="row-fluid">
	  ...
	  <article class="m-widget">
        ...
        <div id="meeting-roomSearch" class="content content-inner">
		  ...
		  <form name="meeting-roomForm" method="post" action="meeting-room.do" class="form-inline">
      ...
      <article class="m-widget">
        ...
        <div class="content">
<form id="meeting-roomGridForm" name="meeting-roomGridForm" method='post' action="meeting-room!removeAll.do" class="m-form-blank">
