...
var config = {
	...
	exportUrl: 'mail-queue-export.do'
};
    ...
    <div class="row-fluid">
	  ...
	  <article class="m-widget">
        ...
        <div id="mailQueueSearch" class="content content-inner">
		  ...
		  <form name="mailQueueForm" method="post" action="mail-queue-list.do" class="form-inline">
	  ...
	  <article class="m-blank">
	    <div class="pull-left">
		  <button class="btn btn-small a-insert" onclick="location.href='mail-queue-input.do'">新建</button>
      ...
      <article class="m-widget">
        ...
        <div class="content">
<form id="mailQueueGridForm" name="mailQueueGridForm" method='post' action="mail-queue-remove.do" class="m-form-blank">
  <table id="mailQueueGrid" class="m-table table-hover">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td>${item.receiver}</td>
        <td>
          <a href="mail-queue-input.do?id=${item.id}" class="a-update"><spring:message code="core.list.edit" text="编辑"/></a>
		  &nbsp;
          <a href="mail-queue-test.do?id=${item.id}">测试</a>
        </td>
      </tr>
      </c:forEach>
    </tbody>
