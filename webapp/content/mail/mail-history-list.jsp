...
var config = {
	...
	exportUrl: 'mail-history-export.do'
};
    ...
    <div class="row-fluid">
	  ...
	  <article class="m-widget">
        ...
        <div id="mailHistorySearch" class="content content-inner">
		  ...
		  <form name="mailHistoryForm" method="post" action="mail-history-list.do" class="form-inline">
	  ...
	  <article class="m-blank">
	    <div class="pull-left">
		<%--
		  <button class="btn btn-small a-insert" onclick="location.href='mail-history-input.do'">新建</button>
      ...
      <article class="m-widget">
        ...
        <div class="content">
<form id="mailHistoryGridForm" name="mailHistoryGridForm" method='post' action="mail-history-remove.do" class="m-form-blank">
  <table id="mailHistoryGrid" class="m-table table-hover">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td>${item.status}</td>
        <td>
          <a href="mail-history-view.do?id=${item.id}">查看</a>
		  &nbsp;
          <a href="mail-history-send.do?id=${item.id}">重发</a>
        </td>
      </tr>
      </c:forEach>
    </tbody>
