...
<form id="mailQueueForm" method="post" action="mail-queue-save.do" class="form-horizontal">
  ...
  <div class="control-group">
	...
	<div class="controls">
	  <select id="mailQueue_mailConfigId" name="mailConfigId">
  ...
  <div class="control-group">
	...
	<div class="controls">
	  <select id="mailQueue_mailTemplateId" name="mailTemplateId">
	  <c:forEach items="${mailTemplates}" var="item">
	    <option value="${item.id}">${item.name}</option>
	  </c:forEach>
	  </select>
    </div>
