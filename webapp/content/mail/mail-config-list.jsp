...
var config = {
	...
	exportUrl: 'mail-config-export.do'
};
    ...
    <div class="row-fluid">
	  ...
	  <article class="m-widget">
        ...
        <div id="mailConfigSearch" class="content content-inner">
		  ...
		  <form name="mailConfigForm" method="post" action="mail-config-list.do" class="form-inline">
	  ...
	  <article class="m-blank">
	    <div class="pull-left">
		  <button class="btn btn-small a-insert" onclick="location.href='mail-config-input.do'">新建</button>
      ...
      <article class="m-widget">
        ...
        <div class="content">
<form id="mailConfigGridForm" name="mailConfigGridForm" method='post' action="mail-config-remove.do" class="m-form-blank">
  <table id="mailConfigGrid" class="m-table table-hover">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td>${item.username}</td>
        <td>
          <a href="mail-config-input.do?id=${item.id}" class="a-update"><spring:message code="core.list.edit" text="编辑"/></a>
		  &nbsp;
          <a href="mail-config-test.do?id=${item.id}">测试</a>
        </td>
      </tr>
      </c:forEach>
    </tbody>
