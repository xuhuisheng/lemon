...
var config = {
	...
	exportUrl: 'car-info!exportExcel.do'
};
    ...
    <div class="row-fluid">
	  ...
	  <article class="m-widget">
        ...
        <div id="car-infoSearch" class="content content-inner">
		  ...
		  <form name="car-infoForm" method="post" action="car-info.do" class="form-inline">
      ...
      <article class="m-widget">
        ...
        <div class="content">
<form id="car-infoGridForm" name="car-infoGridForm" method='post' action="car-info!removeAll.do" class="m-form-blank">
