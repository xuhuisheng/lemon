<%@page contentType="text/html;charset=UTF-8"%>
    ...
    <link href="${cdnPrefix}/bootstrap/3.3.6/css/bootstrap.css" rel="stylesheet" type="text/css">
...
.navbar-inverse .navbar-search .search-query:focus {
    ...
    <script type="text/javascript" src="${cdnPrefix}/bootstrap/3.3.5/js/bootstrap.js"></script>
