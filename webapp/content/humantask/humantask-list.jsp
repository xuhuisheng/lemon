    ...
    <section id="m-main" class="span10">
	  ...
	  <article class="m-widget">
        ...
        <div id="userSearch" class="content content-inner">
		  ...
		  <form name="userForm" method="post" action="humantask-list.do" class="form-inline">
		  </form>
	  ...
	  <article class="m-blank">
	    <div class="pull-left">
		  ...
		  <button class="btn btn-small" onclick="location.href='humantask-input.do'">新建</button>
...
<form id="dynamicModelGridForm" name="dynamicModelGridForm" method='post' action="humantask-remove.do" class="m-form-blank">
  <table id="dynamicModelGrid" class="m-table table-hover">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td>${item.status}</td>
        <td>
          <a href="humantask-input.do?id=${item.id}"><spring:message code="core.list.edit" text="编辑"/></a>
        </td>
      </tr>
      </c:forEach>
    </tbody>
