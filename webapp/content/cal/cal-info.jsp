    ...
    <div class="row-fluid">
	  ...
	  <article class="m-widget">
        ...
        <div id="cal-infoSearch" class="content content-inner">
		  ...
		  <form name="cal-infoForm" method="post" action="cal-info.do" class="form-inline">
      ...
      <article class="m-widget">
        ...
        <div class="content">
<form id="cal-infoGridForm" name="cal-infoGridForm" method='post' action="cal-info!removeAll.do" class="m-form-blank">
