...
<%pageContext.setAttribute("currentMenu", "bpm-mail-template");%>
<!doctype html>
<html>
...
var config = {
	...
	exportUrl: 'bpm-mail-template!exportExcel.do'
};
...
$(function() {
    ...
    <section id="m-main" class="span10">
	  ...
	  <article class="m-widget">
        ...
        <div id="bpmMailTemplateSearch" class="content content-inner">
		  ...
		  <form name="bpmMailTemplateForm" method="post" action="bpm-mail-template.do" class="form-inline">
  ...
  <form id="bpmMailTemplateGridForm" name="bpmMailTemplateGridForm" method='post' action="bpm-mail-template!removeAll.do" style="margin:0px;">
