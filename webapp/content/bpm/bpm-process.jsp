...
var config = {
	...
	exportUrl: 'bpm-process!exportExcel.do'
};
...
$(function() {
    ...
    <section id="m-main" class="span10">
	  ...
	  <article class="m-widget">
        ...
        <div id="bpmProcessSearch" class="content content-inner">
		  ...
		  <form name="bpmProcessForm" method="post" action="bpm-process.do" class="form-inline">
  ...
  <form id="bpmProcessGridForm" name="bpmProcessGridForm" method='post' action="bpm-process!removeAll.do" style="margin:0px;">
