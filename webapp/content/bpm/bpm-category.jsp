...
$(function() {
    ...
    <section id="m-main" class="span10">
	  ...
	  <article class="m-widget">
        ...
        <div id="bpmCategorySearch" class="content content-inner">
		  ...
		  <form name="bpmCategoryForm" method="post" action="bpm-category.do" class="form-inline">
  ...
  <form id="bpmCategoryGridForm" name="bpmCategoryGridForm" method='post' action="bpm-category!removeAll.do" style="margin:0px;">
