  ...
  <body>
    ...
    <section id="m-main" class="span10">
	  ...
	  <article class="m-blank">
	    <div class="pull-left">
		  <button class="btn btn-small" onclick="location.href='user-connector-batch.do'">批量处理</button>
		</div>
...
<form id="userGridForm" name="userGridForm" method='post' action="user-connector!removeAll.do" class="m-form-blank">
