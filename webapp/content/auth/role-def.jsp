    ...
    <section id="m-main" class="span10">
	  ...
	  <article class="m-blank">
	    <div class="pull-left">
		  ...
		  <button class="btn btn-small" onclick="location.href='role-def!input.do'"><spring:message code="core.list.create" text="新建"/></button>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            ...
            <a href="role-def!input.do?id=${item.id}"><spring:message code="core.list.edit" text="编辑"/></a>&nbsp;
			</region:region-permission>
			<region:region-permission permission="roleDef:auth">
            <a href="role-perm.do?id=${item.id}"><spring:message code="auth.roleDef.list.perm" text="设置权限"/></a>
			</region:region-permission>
			<region:region-permission permission="roleDef:auth">
            <a href="role-def!manage.do?id=${item.id}"><spring:message code="auth.roleDef.list.perm" text="管理"/></a>
			</region:region-permission>
          </td>
        </tr>
        </s:iterator>
