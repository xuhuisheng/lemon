...
$(function() {
    ...
    <section id="m-main" class="span10">
	  ...
	  <article class="m-widget">
        ...
        <div id="roleSearch" class="content content-inner">
		  ...
		  <form name="roleForm" method="post" action="role.do" class="form-inline">
	  ...
	  <article class="m-blank">
	    <div class="pull-left">
		  ...
		  <button class="btn btn-small" onclick="location.href='role!input.do'"><spring:message code="core.list.create" text="新建"/></button>
  ...
  <form id="roleGridForm" name="roleGridForm" method='post' action="role!removeAll.do" class="m-form-blank">
