...
var config = {
	...
	exportUrl: 'user-status!exportExcel.do'
};
    ...
    <section id="m-main" class="span10">
	  ...
	  <article class="m-widget">
        ...
        <div id="userSearch" class="content content-inner">
		  ...
		  <form name="userForm" method="post" action="user-status.do" class="form-inline">
	  ...
	  <article class="m-blank">
	    <div class="pull-left">
		  ...
		  <button class="btn btn-small btn-info" onclick="location.href='user-status-batch.do'">批量处理</button>
		</div>
...
<form id="userGridForm" name="userGridForm" method='post' action="user-status!removeAll.do" class="m-form-blank">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td>
            ...
            <a href="javascript:void(0);location.href='user-role.do?id=${item.id}'"><spring:message code="user.user.list.role" text="设置权限"/></a>
			</perm:permission>
        </td>
      </tr>
      </s:iterator>
