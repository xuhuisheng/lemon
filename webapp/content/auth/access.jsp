...
var config = {
	...
	exportUrl: 'access!exportExcel.do'
};
...
$(function() {
    ...
    <section id="m-main" class="span10">
	  ...
	  <article class="m-widget">
        ...
        <div id="accessSearch" class="content content-inner">
		  ...
		  <form name="accessForm" method="post" action="access.do" class="form-inline">
	  ...
	  <article class="m-blank">
	    <div class="pull-left">
		  ...
		  <button class="btn btn-small" onclick="location.href='access!input.do'"><spring:message code="core.list.create" text="新建"/></button>
		  ...
		  <button class="btn btn-small btn-info" onclick="location.href='access-batch.do'">批量处理</button>
		</div>
  ...
  <form id="accessGridForm" name="accessGridForm" method='post' action="access!removeAll.do" class="m-form-blank">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            ...
            <a href="access!input.do?id=${item.id}"><spring:message code="core.list.edit" text="编辑"/></a>&nbsp;
			</region:region-permission>
          </td>
        </tr>
        </s:iterator>
