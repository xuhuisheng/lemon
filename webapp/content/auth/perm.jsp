...
$(function() {
    ...
    <section id="m-main" class="span10">
	  ...
	  <article class="m-widget">
        ...
        <div id="permSearch" class="content content-inner">
		  ...
		  <form name="permForm" method="post" action="perm.do" class="form-inline">
	  ...
	  <article class="m-blank">
	    <div class="pull-left">
		  ...
		  <button class="btn btn-small" onclick="location.href='perm!input.do'"><spring:message code="core.list.create" text="新建"/></button>
  ...
  <form id="permGridForm" name="permGridForm" method='post' action="perm!removeAll.do" class="m-form-blank">
