    ...
    <div class="row-fluid">
	  ...
	  <article class="m-widget">
        ...
        <div id="demoSearch" class="content content-inner">
		  ...
		  <form name="demoForm" method="post" action="whitelist-app-list.do" class="form-inline">
	  ...
	  <article class="m-blank">
	    <div class="pull-left">
		  ...
		  <button class="btn btn-small a-insert" onclick="location.href='whitelist-app-input.do'">新建</button>
      ...
      <article class="m-widget">
        ...
        <div class="content">
<form id="demoGridForm" name="demoGridForm" method='post' action="whitelist-app-remove.do" class="m-form-blank">
