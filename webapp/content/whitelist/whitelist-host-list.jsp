    ...
    <div class="row-fluid">
	  ...
	  <article class="m-widget">
        ...
        <div id="demoSearch" class="content content-inner">
		  ...
		  <form name="demoForm" method="post" action="whitelist-host-list.do" class="form-inline">
	  ...
	  <article class="m-blank">
	    <div class="pull-left">
		  ...
		  <button class="btn btn-small a-insert" onclick="location.href='whitelist-host-input.do'">新建</button>
      ...
      <article class="m-widget">
        ...
        <div class="content">
<form id="demoGridForm" name="demoGridForm" method='post' action="whitelist-host-remove.do" class="m-form-blank">
