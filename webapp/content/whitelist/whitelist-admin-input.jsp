...
<form id="demoForm" method="post" action="whitelist-admin-save.do" class="form-horizontal">
  ...
  <div class="control-group">
    <label class="control-label" for="whitelistApp_userId">接口人</label>
	<div class="controls">
	  <input id="whitelistApp_userId" type="text" name="userId" value="${model.userId}" size="40" class="text required" minlength="2" maxlength="50">
    </div>
  </div>
  <div class="control-group">
    <div class="controls">
