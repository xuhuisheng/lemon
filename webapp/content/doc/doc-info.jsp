...
var config = {
	...
	exportUrl: 'doc-info!exportExcel.do'
};
    ...
    <div class="row-fluid">
	  ...
	  <article class="m-widget">
        ...
        <div id="doc-infoSearch" class="content content-inner">
		  ...
		  <form name="doc-infoForm" method="post" action="doc-info.do" class="form-inline">
      ...
      <article class="m-widget">
        ...
        <div class="content">
<form id="doc-infoGridForm" name="doc-infoGridForm" method='post' action="doc-info!removeAll.do" class="m-form-blank">
