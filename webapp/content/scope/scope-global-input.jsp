...
<html lang="en">
  ...
  <head>
    ...
    <title><spring:message code="scope-global.scope-global.input.title" text="编辑"/></title>
...
<form id="scope-globalForm" method="post" action="scope-global!save.do?operationMode=STORE" class="form-horizontal">
  <s:if test="model != null">
