...
var config = {
	...
	exportUrl: 'scope-info!exportExcel.do'
};
    ...
    <div class="row-fluid">
	  ...
	  <article class="m-widget">
        ...
        <div id="scope-infoSearch" class="content content-inner">
		  ...
		  <form name="scope-infoForm" method="post" action="scope-info.do" class="form-inline">
      ...
      <article class="m-widget">
        ...
        <div class="content">
<form id="scope-infoGridForm" name="scope-infoGridForm" method='post' action="scope-info!removeAll.do" class="m-form-blank">
