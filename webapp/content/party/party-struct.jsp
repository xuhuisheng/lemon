...
var config = {
	...
	exportUrl: 'party-struct!exportExcel.do'
};
...
$(function() {
    ...
    <section id="m-main" class="span10">
	  ...
	  <article class="m-widget">
        ...
        <div id="orgstructSearch" class="content content-inner">
		  ...
		  <form name="orgstructForm" method="post" action="party-struct.do" class="form-inline">
  ...
  <form id="orgStructGridForm" name="orgStructGridForm" method='post' action="party-struct!removeAll.do" class="m-form-blank">
    <table id="orgStructGrid" class="m-table table-hover">
      <thead>
        <tr>
          <th width="10" class="m-table-check"><input type="checkbox" name="checkAll" onchange="toggleSelectedItems(this.checked)"></th>
          <th class="sorting" name="orgStructType.id"><spring:message code="org.struct.list.type" text="类型"/></th>
