...
var config = {
	...
	exportUrl: 'party-dim-root!exportExcel.do'
};
...
$(function() {
    ...
    <section id="m-main" class="span10">
	  ...
	  <article class="m-widget">
        ...
        <div id="orgtypeSearch" class="content content-inner">
		  ...
		  <form name="orgtypeForm" method="post" action="org-type.do" class="form-inline">
  ...
  <form id="orgTypeGridForm" name="orgTypeGridForm" method='post' action="party-dim-root!removeAll.do" class="m-form-blank">
