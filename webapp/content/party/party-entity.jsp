...
var config = {
	...
	exportUrl: 'party-entity!exportExcel.do'
};
...
$(function() {
    ...
    <section id="m-main" class="span10">
	  ...
	  <article class="m-widget">
        ...
        <div id="orgEntitySearch" class="content content-inner">
		  ...
		  <form name="orgEntityForm" method="post" action="party-entity.do" class="form-inline">
  ...
  <form id="orgEntityGridForm" name="orgEntityGridForm" method='post' action="party-entity!removeAll.do" class="m-form-blank">
