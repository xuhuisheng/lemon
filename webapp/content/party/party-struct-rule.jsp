...
var config = {
	...
	exportUrl: 'party-struct-rule!exportExcel.do'
};
...
$(function() {
    ...
    <section id="m-main" class="span10">
	  ...
	  <article class="m-widget">
        ...
        <div id="orgstructruleSearch" class="content content-inner">
		  ...
		  <form name="orgstructruleForm" method="post" action="party-struct-rule.do" class="form-inline">
  ...
  <form id="orgStructRuleGridForm" name="orgStructRuleGridForm" method='post' action="party-struct-rule!removeAll.do" class="m-form-blank">
