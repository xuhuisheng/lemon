...
var config = {
	...
	exportUrl: 'party-struct-type!exportExcel.do'
};
...
$(function() {
    ...
    <section id="m-main" class="span10">
	  ...
	  <article class="m-widget">
        ...
        <div id="orgstructtypeSearch" class="content content-inner">
		  ...
		  <form name="orgstructtypeForm" method="post" action="party-struct-type.do" class="form-inline">
  ...
  <form id="orgStructTypeGridForm" name="orgStructTypeGridForm" method='post' action="party-struct-type!removeAll.do" class="m-form-blank">
