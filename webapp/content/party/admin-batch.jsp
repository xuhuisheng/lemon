...
<form id="orgForm" method="post" action="admin-batch!input.do?operationMode=STORE&id=${id}&groupTypeId=${groupTypeId}" class="form-horizontal">
  ...
  <form id="userGridForm" name="orgEntityGridForm" method='post' action="admin-batch!removeAll.do?id=${id}&groupTypeId=${groupTypeId}" class="m-form-blank">
