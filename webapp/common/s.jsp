<%@page language="java" pageEncoding="UTF-8" %>
    ...
    <!-- bootstrap -->
    <link type="text/css" rel="stylesheet" href="${cdnPrefix}/bootstrap/css/bootstrap.min.css">
    <link type="text/css" rel="stylesheet" href="${cdnPrefix}/bootstrap/css/bootstrap-responsive.min.css">

    <!-- html5 -->
    <!--[if lt IE 9]>
    <link rel="stylesheet" type="text/css" href="${cdnPrefix}/mossle/css/ie.css" media="screen" />
    ...
    <!-- layout -->
    <script type="text/javascript" src="${cdnPrefix}/mossle/js/hideshow.js"></script>
    <script type="text/javascript" src="${cdnPrefix}/mossle/js/jquery.equalHeight.js"></script>
    ...
    <!-- uniform -->
    <link type="text/css" rel="stylesheet" href="${cdnPrefix}/uniform/css/uniform.default.css" media="screen" />
    <script type="text/javascript" src="${cdnPrefix}/uniform/js/jquery.uniform.min.js"></script>
    ...
    <link href="${cdnPrefix}/bootstrap-datetimepicker/css/datetimepicker.css" rel="stylesheet">
	...
	<!-- uniform -->
    <link rel="stylesheet" href="${cdnPrefix}/uniform/css/uniform.default.min.css" type="text/css" media="screen" />
    <script type="text/javascript" src="${cdnPrefix}/uniform/js/jquery.uniform.min.js"></script>

	<!-- chozen -->
    <link rel="stylesheet" href="${cdnPrefix}/chosen/chosen.css" type="text/css" media="screen" />
    <script type="text/javascript" src="${cdnPrefix}/chosen/chosen.jquery.min.js"></script>
	...
	<!-- layout -->
    <link type="text/css" rel="stylesheet" href="${cdnPrefix}/mossle/css/layout3.css" media="screen" />
