  ...
  <div class="container-fluid">
    <div class="navbar-header">
      <a class="navbar-brand" href="${tenantPrefix}">
        ...
        Lemon <sub><small>${prop.app_version}</small></sub>
      </a>
    </div>
...
<form id="userForm" name="f" method="post" action="${tenantPrefix}/j_spring_security_check" class="form-horizontal">
  <div class="form-group" id="tenantField">
  ...
  <div class="form-group">
    ...
    <div class="col-md-10">
      ...
      <label for="_spring_security_remember_me">两周内自动登录</label>
    </div>
  </div>
  <div class="form-group">
    ...
    <div class="col-md-10">
      ...
      <!--
      &nbsp;
      <a href="${tenantPrefix}/guest/forget-password-view.do">忘记密码</a>
      -->
    </div>
  </div>
</form>
