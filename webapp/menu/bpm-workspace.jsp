      ...
      <aside id="m-sidebar" class="accordion span2" data-spy="affix" data-offset-top="100">
        ...
        <div class="accordion-group">
          ...
          <div id="collapse-cal" class="accordion-body collapse ${currentMenu == 'cal' ? 'in' : ''}">
            <ul class="accordion-inner nav nav-list">
			  <li><a href="${scopePrefix}/cal/cal-info.do"><i class="icon-user"></i>查看日程</a></li>
        ...
        <div class="accordion-group">
          ...
          <div id="collapse-doc" class="accordion-body collapse ${currentMenu == 'doc' ? 'in' : ''}">
            <ul class="accordion-inner nav nav-list">
			  <li><a href="${scopePrefix}/doc/doc-info.do"><i class="icon-user"></i>查看文件</a></li>
        ...
        <div class="accordion-group">
          ...
          <div id="collapse-address-list" class="accordion-body collapse ${currentMenu == 'address-list' ? 'in' : ''}">
            <ul class="accordion-inner nav nav-list">
			  <li><a href="${scopePrefix}/addresslist/address-list.do"><i class="icon-user"></i>通讯录</a></li>
            </ul>
          </div>
        </div>
        ...
        <div class="accordion-group">
          ...
          <div id="collapse-car" class="accordion-body collapse ${currentMenu == 'car' ? 'in' : ''}">
            <ul class="accordion-inner nav nav-list">
			  <li><a href="${scopePrefix}/car/car-info.do"><i class="icon-user"></i>车辆管理</a></li>
            </ul>
          </div>
        </div>
        ...
        <div class="accordion-group">
          ...
          <div id="collapse-meeting" class="accordion-body collapse ${currentMenu == 'meeting' ? 'in' : ''}">
            <ul class="accordion-inner nav nav-list">
			  <li><a href="${scopePrefix}/meeting/meeting-room.do"><i class="icon-user"></i>会议室管理</a></li>
			  <li><a href="${scopePrefix}/meeting/meeting-info.do"><i class="icon-user"></i>会议预定</a></li>
            </ul>
          </div>
        </div>
