...
@Component
public class ExpenseModuleSpecification implements ModuleSpecification {
    private static final String MODULE_NAME = "expense";
    ...
    @Value("${" + MODULE_NAME + ".dbmigrate.enabled:true}")
