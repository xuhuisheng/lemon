package com.mossle.performance.persistence.domain;
...
public class PerformanceInfo implements java.io.Serializable {
    ...
    public PerformanceInfo(Long id, String name, Date createTime,
            String status, String type, Date startTime, Date endTime,
            String employeeId, String superiourId, String score, String tenantId) {
        this.id = id;
        this.name = name;
