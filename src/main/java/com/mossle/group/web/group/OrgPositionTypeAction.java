...
@Results(@Result(name = OrgPositionTypeAction.RELOAD, location = "org-position-type.do?operationMode=RETRIEVE", type = "redirect"))
public class OrgPositionTypeAction extends BaseAction implements
        ModelDriven<OrgPositionType>, Preparable {
    public static final String RELOAD = "reload";
    private OrgPositionTypeManager orgPositionTypeManager;
    private MessageSourceAccessor messages;
    private Page page = new Page();
    private OrgPositionType model;
    private long id;
    ...
    public String input() {
        if (id > 0) {
            model = orgPositionTypeManager.get(id);
        }
    ...
    public void exportExcel() throws Exception {
        ...
        List<OrgPositionType> orgCompanies = (List<OrgPositionType>) page
                .getResult();
    ...
    public OrgPositionType getModel() {
        return model;
    }
