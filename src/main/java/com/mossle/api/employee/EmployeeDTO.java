...
public class EmployeeDTO {
    ...
    public String getSuperiourUsername() {
        return this.superiourUsername;
    }

    public void setSuperiourUsername(String superiourUsername) {
        this.superiourUsername = superiourUsername;
    }
