package com.mossle.budget.persistence.domain;
...
public class BudgetInfo implements java.io.Serializable {
    ...
    public BudgetInfo(Long id) {
        this.id = id;
    }

    public BudgetInfo(Long id, String name, Date createTime, String status,
