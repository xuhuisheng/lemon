package com.mossle.internal.sequence;
...
@Component
public class SequenceModuleSpecification implements ModuleSpecification {
    private static final String MODULE_NAME = "sequence";
