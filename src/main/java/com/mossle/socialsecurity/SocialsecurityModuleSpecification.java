package com.mossle.socialsecurity;
...
@Component
public class SocialsecurityModuleSpecification implements ModuleSpecification {
    private static final String MODULE_NAME = "socialsecurity";
