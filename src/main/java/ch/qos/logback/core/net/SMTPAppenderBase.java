...
public abstract class SMTPAppenderBase<E> extends AppenderBase<E> {
    ...
    private String jndiLocation = CoreConstants.JNDI_COMP_PREFIX
            + "/mail/Session";
    String username;
    String password;
    String localhost;
    ...
    protected void sendBuffer(CyclicBuffer<E> cb, E lastEventObject) {
        ...
        try {
            ...
            if (subjectLayout != null) {
                ...
                // new-line character.
                int newLinePos = (subjectStr != null) ? subjectStr
                        .indexOf('\n') : (-1);
            ...
            InternetAddress[] toAddressArray = destinationAddresses
                    .toArray(EMPTY_IA_ARRAY);
            ...
            Transport transport = session.getTransport(session
